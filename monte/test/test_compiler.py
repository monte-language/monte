...
class CompilerTest(unittest.TestCase):
    ...
    def test_tripleNest(self):
        self.eq_(
            ...
            outer.run(_monte.wrap(0)).inner(_monte.wrap(1))
            """)
            ...
            object foo {
             ...
             class _m_foo_Script(_monte.MonteObject):
                 ...
                 def baz(foo, _g_Final1, y):
                     ...
                     return _m_outerScope["__makeList"].run(left, right)
    ...
    def test_auditBindingGuards(self):
        self.eq_(
            ...
            class _m_foo_Script(_monte.MonteObject):
                ...
                def run(foo):
                    return _m_outerScope["__makeList"].run(foo.x, foo.y, foo.z, foo.w)
