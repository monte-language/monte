...
class ParserTest(unittest.TestCase):
    ...
    def test_collections(self):
        ...
        self.assertEqual(parse("[1=> a, => &x, => y]"), ["MapExpr", [["MapExprAssoc", ["LiteralExpr", 1], ["NounExpr", "a"]], ["MapExprExport", ["Slot", "x"]], ["MapExprExport", ["NounExpr", "y"]]]])
    ...
    def test_prefix(self):
        ...
        self.assertEqual(parse("&x"), ["Slot", "x"])
    ...
    def test_object(self):
        ...
        """
        parse = self.getParser("expr")
        self.assertEqual(parse("def foo {}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("def _ {}"), ["Object", None, ["IgnorePattern", None], ["Script", None, [], [], []]])
        self.assertEqual(parse("def bind foo {}"), ["Object", None, ["BindPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("def var foo {}"), ["Object", None, ["VarPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("bind foo {}"), ["Object", None, ["BindPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("var foo {}"), ["Object", None, ["VarPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("/** yes */ def foo {}"),  ["Object", "yes", ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], []]])
        self.assertEqual(parse("def foo implements A {}"),  ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [["NounExpr", "A"]], [], []]])
        self.assertEqual(parse("def foo extends B {}"),  ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", ["NounExpr", "B"], [], [], []]])
        self.assertEqual(parse("def foo extends B implements A {}"),  ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", ["NounExpr", "B"], [["NounExpr", "A"]], [], []]])
        self.assertEqual(parse("def foo {to baz(x) {1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["To", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {/** woot */ to baz(x) {1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["To", "woot", "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {\nto baz(x) {\n1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["To", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {\nto baz() {\n1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["To", None, "baz", [], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {method baz(x) {1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["Method", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {match [verb, args] {1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [], [["Matcher", ["ListPattern", [["FinalPattern", ["NounExpr", "verb"], None], ["FinalPattern", ["NounExpr", "args"], None]], None], ["LiteralExpr", 1]]]]])
        ...
        self.assertEqual(parse("bind foo {method baz(x) {1}}"), ["Object", None, ["BindPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["Method", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("var foo {method baz(x) {1}}"), ["Object", None, ["VarPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["Method", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], None, ["LiteralExpr", 1]]], []]])
        self.assertEqual(parse("def foo {to baz(x) :any {1}}"), ["Object", None, ["FinalPattern", ["NounExpr", "foo"], None], ["Script", None, [], [["To", None, "baz", [["FinalPattern", ["NounExpr", "x"], None]], ["Guard", ["NounExpr", "any"], []], ["LiteralExpr", 1]]], []]])
