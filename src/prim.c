...
static void set_up_prims(void) {
  ...
  e_make_script(&e__null_script, NULL, null_methods, justSelfless, "void");
  e_make_script(&e__boolean_script, NULL, boolean_methods, justSelfless,
                "Boolean");
  e_make_script(&e__char_script, NULL, char_methods, justSelfless, "char");
  e_make_script(&e__string_script, NULL, string_methods,
                justSelfless, "String");
  e_make_script(&e__fixnum_script, NULL, fixnum_methods,
                justSelfless, "int");
  e_make_script(&e__bignum_script, NULL, bignum_methods,
                justSelfless, "bigint");
  e_make_script(&e__float64_script, NULL, float64_methods,
                justSelfless, "float64");
  e_make_script(&e__writer_script, NULL, writer_methods, NULL, "writer");
  e_make_script(&e__reader_script, NULL, reader_methods, NULL, "reader");
  e_make_script(&e__flexmap_script, NULL, flexmap_methods, NULL, "FlexMap");
  e_make_script(&e__constmap_script, NULL, constmap_methods,
                justSelfless, "Map");
  e_make_script(&e__constlist_script, NULL, constlist_methods,
                justSelfless, "List");
  e_make_script(&e__flexlist_script, NULL, flexlist_methods, NULL,
                "FlexList");
  e_make_script(&e__constset_script, NULL, constset_methods,
                NULL, "Set");
  e_make_script(&e__flexset_script, NULL, flexset_methods, NULL, "FlexSet");
  e_make_script(&problem_script, NULL, problem_methods, NULL, "problem");
  e_make_script(&e__finalslot_script, NULL, finalslot_methods,
                NULL, "FinalSlot");
  e_make_script(&e__varslot_script, NULL, varslot_methods,
                NULL, "SettableSlot");
  e_make_script(&e__guardedslot_script, NULL, guardedslot_methods,
                NULL, "SettableSlot");
  e_make_script(&e__ejector_script, NULL, ejector_methods,
                NULL, "Ejector");
