# -*- coding: utf-8 -*-
#
# Monte documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Monte.tex', u'Monte Documentation',
   u'Monte Project', 'manual'),
]
...
man_pages = [
    ('index', 'monte', u'Monte Documentation',
     [u'Monte Project'], 1)
]
...
texinfo_documents = [
  ('index', 'Monte', u'Monte Documentation',
   u'Monte Project', 'Monte', 'One line description of project.',
   'Miscellaneous'),
]
